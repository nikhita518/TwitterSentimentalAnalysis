...
class TwitterClient(object): 
    ...
    def __init__(self): 
        ...
        consumer_key = 'ebuklmvsLHTEBfk5kSn9roFz2'
        consumer_secret = 'jvdt8tzNpRTXdLa5s4FeTiZZrzfo3js3NnXnW9sdekqcFAL159'
        access_token = '906794650920304640-FI13JGDbWYClyqgdSRaxUb30RJ1cEtf'
...
def main(input1): 
    ...
    res = [round(positivepercent),round(negativepercent),round(neutralpercent)]
